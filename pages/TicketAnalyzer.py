...
if tickets.empty:
    ...
    if choice:
        ...
        with col2:
            st.write(f"**Category:** {selected_ticket.get('category', 'N/A')}")
            st.write(f"**Assigned To:** {selected_ticket.get('assigned_to', 'Unassigned')}")
            st.write(f"**Created Date:** {selected_ticket.get('created_date', 'N/A')}")
        
        st.write(f"**Description:** {selected_ticket.get('description', 'No description')}")
